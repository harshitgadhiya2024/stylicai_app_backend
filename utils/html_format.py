...
class htmlOperation():
    ...
    def send_photoshoot_notification(self):
        try:
            notification = """
                <!DOCTYPE html>
                <html lang="en">
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Hello Developer,</p>
                            <p>You got the new photoshoot from click side so please take a look and make a photoshoot ASAP</p>
            ...
            print(f"{datetime.now()}: Error in getting send photoshoot notification html format: {str(e)}")
